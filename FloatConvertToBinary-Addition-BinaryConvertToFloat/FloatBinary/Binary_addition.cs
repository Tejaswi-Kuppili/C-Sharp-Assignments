...
{
    /// <summary>
    /// Calling check_binary method to obtain result in which both binary numbers have same length
    /// </summary>
    ...
    /// <summary>
    /// Checking whether both binary numbers will have same length by adding appropriate zeroes at ending or strarting
    /// </summary>
    /// <param name="binary1"></param>
    /// <param name="binary2"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Adding the 2 binary numbers by splitting them into int and decimal values
    /// </summary>
    ...
    public double add_binary(string str1, string str2, string str3, string str4)
    {
        int carry = 0;
        string res1 = "";
        //Adding decimal points of the binary numbers
    ...
    /// <summary>
    /// Converting the binary values into double values
    /// </summary>
